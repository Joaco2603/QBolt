...
from optimizer.quantum.qaoa.backends import (
...
def test_nexus_backend_uses_unique_names_and_project(monkeypatch) -> None:
    from optimizer.quantum.qaoa import backends as backend_module
    from optimizer.quantum.qaoa.backends import NexusBackend
    from optimizer.quantum.qaoa.qaoa import QAOAProgram
